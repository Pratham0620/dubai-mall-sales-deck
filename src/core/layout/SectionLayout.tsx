...
export const SectionLayout: React.FC<SectionLayoutProps> = ({ 
  ...
  return (
    ...
    >
      {backgroundVideo ? (
        <video
          className={`absolute inset-0 z-0 h-full w-full object-cover transform-gpu pointer-events-none ${isDark ? 'opacity-40 grayscale-[0.2] brightness-95' : 'opacity-30 grayscale contrast-125'}`}
          src={backgroundVideo}
          autoPlay
          muted
          loop
        ...
        <div 
          className="absolute inset-0 z-0 bg-cover bg-center transform-gpu scale-105 will-change-transform"
          style={{ 
