...
export const DiningSection: React.FC = () => {
  const highlights = [
    { title: 'Fine Dining', venue: 'The Avenue collection' },
    { title: 'Global Flavors', venue: 'International Food Hall' },
    { title: 'Celebrity Chefs', venue: 'Exclusive Partnerships' }
  ];
    ...
    <SectionLayout backgroundImage="https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?auto=format&fit=crop&q=80">
      <div className="grid lg:grid-cols-2 gap-24 items-center font-sans">
        ...
        >
          ...
          {/* Corner Decal */}
          <div className="absolute top-8 right-8 bg-black text-white px-4 py-2 text-[10px] font-black uppercase tracking-widest pointer-events-none">
            Asset_Ref // 4022
          </div>
        </motion.div>
      </div>
