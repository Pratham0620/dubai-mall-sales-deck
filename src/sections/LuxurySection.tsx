...
export const LuxurySection: React.FC = () => {
  ...
  return (
    <SectionLayout backgroundImage={SECTION_MEDIA.luxury.background}>
      <div className="flex flex-col justify-center relative font-sans">
        ...
        <div className="mb-8 md:mb-10 border-b-8 border-black pb-6 relative z-10">
          <motion.div
            ...
            whileInView="visible"
          >
            <span className="text-black font-black text-[10px] md:text-xs uppercase tracking-[0.45em] md:tracking-[0.6em] mb-4 block">
          ...
          <motion.div
            ...
            whileInView="visible"
          >
            <h2 className="text-5xl md:text-[clamp(3rem,7vw,6.5rem)] font-black text-black leading-[0.82] uppercase tracking-tighter">
              Absolute<br />
        ...
        <div className="grid md:grid-cols-4 gap-4 relative z-10">
          {brands.map((brand, idx) => (
            ...
            >
              <DeckCard className="p-5 md:p-6 min-h-64 md:min-h-72 flex flex-col justify-between hover:bg-black hover:text-white duration-700 ease-out">
        ...
        >
          ...
          <p className="max-w-2xl text-black font-black text-base md:text-lg uppercase tracking-tight italic border-l-4 border-black pl-5 md:pl-6 leading-tight">
